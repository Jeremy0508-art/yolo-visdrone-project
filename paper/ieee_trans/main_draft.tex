...
\begin{figure*}[t]
  \centering
  \includegraphics[width=0.98\textwidth]{csgate_schematic.png}
  \caption{CrossScaleP2P3ConsistencyGate (CSGate) schematic. The module aligns adjacent P3 semantic context with P2 detail, estimates a consistency gate, and applies an identity-initialized bounded residual correction to the P2 feature. The figure is structural and encodes no performance value.}
  \label{fig:csgate_schematic}
\end{figure*}
