...
| --- | ---: | ---: | ---: | --- |
| Phase 1 artifacts | 75 | 5 | OK | `paper/ieee_phase1_artifact_audit.md` |
...
| IEEE table drafts | 13 | 0 | OK | `paper/ieee_table_audit.md` |
...
| Evidence-to-section map | 16 rows | n/a | n/a | `paper/ieee_trans/evidence_to_sections.csv` |
