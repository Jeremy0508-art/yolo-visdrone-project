...
- Local rest status: OPEN_SECOND_CYCLE_EXPERIMENTS; submission status: NOT_READY_WAITING_FOR_EXPERIMENT_AND_MANUAL_GATES.
...
| --- | ---: | ---: | ---: | --- |
| Phase 1 artifacts | 151 | 4 | OK | `paper/ieee_phase1_artifact_audit.md` |
| Claim audit | 1 | 3 | OK | `paper/ieee_claim_audit.md` |
| Server progress | 7 | 1 partial / 0 connection failed | 1 | `paper/ieee_server_progress_report.md` |
| Scale-wise outputs | 6 | 0 | OK | `paper/ieee_scale_output_audit.md` |
| Experiment registry | 20 complete | 0 | 0 partial | `paper/ieee_experiment_registry_audit.md` |
...
| Main draft number audit | 27 | 1 ignored | OK | `paper/ieee_main_draft_number_audit.md` |
...
| Evidence-to-section map | 23 | n/a | OK | `paper/ieee_evidence_map_audit.md` |
| Manuscript assembly audit | 47 | 4 | OK | `paper/ieee_manuscript_assembly_audit.md` |
...
| CSGate result gate | 9 | 2 | OK | WAITING_FOR_COMPLETE_CSGATE_RESULTS; complete runs n/a |
| CSGate method decision | 6 | 5 | OK | LOCKED_WAITING_FOR_COMPLETE_CSGATE_RESULTS; accepted routes none |
...
| IEEE goal readiness | 58 | 6 | OK | OPEN_SECOND_CYCLE_EXPERIMENTS; NOT_READY_WAITING_FOR_EXPERIMENT_AND_MANUAL_GATES; `paper/ieee_goal_readiness_audit.md` |
...
| CSGate paper-use gate | CSGate rows, diagnostics, speed, and manuscript claims | WAITING_FOR_COMPLETE_CSGATE_RESULTS | `paper/ieee_csgate_result_gate_audit.md` | Do not sync or cite partial CSGate metrics. |
| CSGate method decision | Acceptance routes A/B/C | LOCKED_WAITING_FOR_COMPLETE_CSGATE_RESULTS | `paper/ieee_csgate_method_decision_audit.md` | Do not promote CSGate unless an acceptance route passes after complete results. |
