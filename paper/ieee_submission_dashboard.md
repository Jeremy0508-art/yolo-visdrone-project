...
| --- | ---: | ---: | ---: | --- |
| Phase 1 artifacts | 104 | 6 | OK | `paper/ieee_phase1_artifact_audit.md` |
| Claim audit | 1 | 3 | OK | `paper/ieee_claim_audit.md` |
| Server progress | 1 | 0 partial / 0 connection failed | 4 | `paper/ieee_server_progress_report.md` |
| Scale-wise outputs | 6 | 0 | OK | `paper/ieee_scale_output_audit.md` |
| Experiment registry | 14 complete | 4 | 0 partial | `paper/ieee_experiment_registry_audit.md` |
...
| Number trace audit | 71 | 0 | 0 untracked | `paper/ieee_number_trace_audit.md` |
