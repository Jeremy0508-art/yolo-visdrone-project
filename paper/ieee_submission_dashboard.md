...
| --- | ---: | ---: | ---: | --- |
| Phase 1 artifacts | 62 | 5 | OK | `paper/ieee_phase1_artifact_audit.md` |
...
- Manuscript blueprint, abstract workbench, and section draft pack: `paper/ieee_trans/manuscript_blueprint.md`, `paper/ieee_trans/abstract_contribution_workbench.md`, `paper/ieee_trans/section_draft_pack.md`
