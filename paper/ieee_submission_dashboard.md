...
| --- | ---: | ---: | ---: | --- |
| Phase 1 artifacts | 103 | 7 | OK | `paper/ieee_phase1_artifact_audit.md` |
| Claim audit | 1 | 3 | OK | `paper/ieee_claim_audit.md` |
| Server progress | 0 | 0 partial / 0 connection failed | 5 | `paper/ieee_server_progress_report.md` |
...
| Evidence-to-section map | 20 | n/a | OK | `paper/ieee_evidence_map_audit.md` |
| Manuscript assembly audit | 34 | 5 | OK | `paper/ieee_manuscript_assembly_audit.md` |
| Reference metadata readiness | 18 | 1 | OK | `paper/ieee_reference_metadata_readiness_audit.md` |
| Related-work matrix | 25 rows | n/a | n/a | `paper/ieee_related_work_matrix.csv` |
| Evidence-to-section CSV | 20 rows | n/a | n/a | `paper/ieee_trans/evidence_to_sections.csv` |
