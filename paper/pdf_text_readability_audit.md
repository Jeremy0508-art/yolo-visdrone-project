...
| PDF is newer than LaTeX source | READY | `pdf_mtime=1781405501, tex_mtime=1781405301` |  |
| PDF text extraction | READY | `PyMuPDF extracted 19781 characters from 15 pages` |  |
| Extracted text length | READY | `19781 extracted characters` |  |
