...
| PDF is newer than LaTeX source | READY | `pdf_mtime=1781377475, tex_mtime=1781377441` |  |
| PDF text extraction | READY | `PyMuPDF extracted 19395 characters from 15 pages` |  |
| Extracted text length | READY | `19395 extracted characters` |  |
