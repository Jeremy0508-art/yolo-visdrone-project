...
| --- | --- | --- | --- |
| Compiled PDF exists | READY | `paper\manuscript_submission_candidate.pdf (1683.8 KB)` |  |
| PDF is newer than LaTeX source | READY | `pdf_mtime=1781370598, tex_mtime=1781370506` |  |
| PDF text extraction | READY | `PyMuPDF extracted 17777 characters from 14 pages` |  |
| Extracted text length | READY | `17777 extracted characters` |  |
