...
| --- | --- | --- | --- |
| Compiled PDF exists | READY | `paper\manuscript_submission_candidate.pdf (1695.0 KB)` |  |
| PDF is newer than LaTeX source | READY | `pdf_mtime=1781512394, tex_mtime=1781511764` |  |
| PDF text extraction | READY | `PyMuPDF extracted 19896 characters from 15 pages` |  |
| Extracted text length | READY | `19896 extracted characters` |  |
