...
| --- | --- | --- | --- |
| Compiled PDF exists | READY | `paper\manuscript_submission_candidate.pdf (1684.5 KB)` |  |
| PDF is newer than LaTeX source | READY | `pdf_mtime=1781377193, tex_mtime=1781377030` |  |
| PDF text extraction | READY | `PyMuPDF extracted 17848 characters from 14 pages` |  |
| Extracted text length | READY | `17848 extracted characters` |  |
