...
| Core Documents | Paper workspace README | READY | `paper/README.md` | 9.0 KB |
...
| Core Documents | Reproducibility commands | READY | `paper/commands.md` | 16.0 KB |
...
| Core Documents | CEA submission package checklist | READY | `paper/CEA_SUBMISSION_PACKAGE_CHECKLIST.md` | 3.7 KB |
| Core Documents | Advisor progress brief | READY | `paper/advisor_progress_brief.md` | 4.6 KB |
| Core Documents | Execution log | READY | `paper/CEA_EXECUTION_LOG.md` | 41.5 KB |
...
| Tables | Server status history table | READY | `paper/tables/cea_server_status_history.csv` | 130 data rows |
...
| Audits | Submission audit dashboard | READY | `paper/submission_audit_dashboard.md` | 3.6 KB |
| Audits | Submission readiness audit | READY | `paper/submission_readiness_audit.md` | 11.3 KB |
...
| Audits | Reproducibility command audit | READY | `paper/repro_commands_audit.md` | 5.0 KB |
