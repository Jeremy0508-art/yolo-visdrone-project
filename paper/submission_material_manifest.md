...
| Core Documents | Paper workspace README | READY | `paper/README.md` | 8.5 KB |
...
| Core Documents | Reproducibility commands | READY | `paper/commands.md` | 15.1 KB |
...
| Core Documents | Execution log | READY | `paper/CEA_EXECUTION_LOG.md` | 37.4 KB |
...
| Tables | Server status history table | READY | `paper/tables/cea_server_status_history.csv` | 110 data rows |
...
| Audits | Reproducibility command audit | READY | `paper/repro_commands_audit.md` | 4.6 KB |
| Audits | Config inventory audit | READY | `paper/config_inventory_audit.md` | 2.3 KB |
| Audits | Text hygiene audit | READY | `paper/text_hygiene_audit.md` | 2.4 KB |
