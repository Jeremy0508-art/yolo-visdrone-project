...
| Tables | Server status history table | READY | `paper/tables/cea_server_status_history.csv` | 30 data rows |
...
| Audits | Submission readiness audit | READY | `paper/submission_readiness_audit.md` | 8.3 KB |
