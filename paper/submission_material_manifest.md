...
| Core Documents | Paper workspace README | READY | `paper/README.md` | 9.1 KB |
...
| Core Documents | Reproducibility commands | READY | `paper/commands.md` | 16.3 KB |
...
| Core Documents | CEA submission package checklist | READY | `paper/CEA_SUBMISSION_PACKAGE_CHECKLIST.md` | 3.8 KB |
| Core Documents | CEA manual submission preflight | READY | `paper/CEA_MANUAL_SUBMISSION_PREFLIGHT.md` | 3.1 KB |
| Core Documents | Advisor progress brief | READY | `paper/advisor_progress_brief.md` | 4.6 KB |
| Core Documents | Execution log | READY | `paper/CEA_EXECUTION_LOG.md` | 42.4 KB |
...
| Tables | Server status history table | READY | `paper/tables/cea_server_status_history.csv` | 135 data rows |
...
| Audits | Submission audit dashboard | READY | `paper/submission_audit_dashboard.md` | 3.9 KB |
| Audits | Submission readiness audit | READY | `paper/submission_readiness_audit.md` | 11.7 KB |
...
| Audits | Synced fair-experiment artifacts audit | READY | `paper/synced_fair_experiment_artifacts_audit.md` | 2.1 KB |
| Audits | Reproducibility command audit | READY | `paper/repro_commands_audit.md` | 5.1 KB |
| Audits | Config inventory audit | READY | `paper/config_inventory_audit.md` | 2.3 KB |
| Audits | Text hygiene audit | READY | `paper/text_hygiene_audit.md` | 2.8 KB |
