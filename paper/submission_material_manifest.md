...
| Core Documents | Paper workspace README | READY | `paper/README.md` | 7.2 KB |
...
| Core Documents | Execution log | READY | `paper/CEA_EXECUTION_LOG.md` | 26.4 KB |
...
| Tables | Server status history table | READY | `paper/tables/cea_server_status_history.csv` | 45 data rows |
...
| Audits | Submission readiness audit | READY | `paper/submission_readiness_audit.md` | 8.4 KB |
