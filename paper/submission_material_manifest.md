...
| Core Documents | Paper workspace README | READY | `paper/README.md` | 7.3 KB |
...
| Core Documents | Execution log | READY | `paper/CEA_EXECUTION_LOG.md` | 27.2 KB |
...
| Tables | Server status history table | READY | `paper/tables/cea_server_status_history.csv` | 55 data rows |
