...
| Core Documents | Paper workspace README | READY | `paper/README.md` | 6.7 KB |
| Core Documents | Submission checklist | READY | `paper/submission_checklist.md` | 4.2 KB |
| Core Documents | Reproducibility commands | READY | `paper/commands.md` | 12.4 KB |
| Core Documents | Result integration protocol | READY | `paper/CEA_RESULT_INTEGRATION_PROTOCOL.md` | 5.2 KB |
| Core Documents | Execution log | READY | `paper/CEA_EXECUTION_LOG.md` | 24.1 KB |
| Core Documents | Server status snapshot | READY | `paper/cea_server_status_snapshot.md` | 1.5 KB |
| Core Documents | Server progress report | READY | `paper/cea_server_progress_report.md` | 1.6 KB |
...
| Tables | Server status history table | READY | `paper/tables/cea_server_status_history.csv` | 10 data rows |
...
| Audits | Submission readiness audit | READY | `paper/submission_readiness_audit.md` | 8.0 KB |
...
| Audits | Reproducibility command audit | READY | `paper/repro_commands_audit.md` | 3.5 KB |
