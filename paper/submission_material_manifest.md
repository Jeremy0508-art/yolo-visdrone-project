...
| Core Documents | Paper workspace README | READY | `paper/README.md` | 11.3 KB |
...
| Core Documents | Reproducibility commands | READY | `paper/commands.md` | 17.8 KB |
...
| Core Documents | CEA manual submission preflight | READY | `paper/CEA_MANUAL_SUBMISSION_PREFLIGHT.md` | 3.2 KB |
...
| Core Documents | Advisor review package manifest | READY | `paper/advisor_review_package_manifest.md` | 3.8 KB |
| Core Documents | Advisor review package zip | READY | `paper/advisor_review_package.zip` | 3.32 MB |
...
| Audits | Submission audit dashboard | READY | `paper/submission_audit_dashboard.md` | 4.5 KB |
| Audits | Submission readiness audit | READY | `paper/submission_readiness_audit.md` | 14.2 KB |
...
| Audits | Reproducibility command audit | READY | `paper/repro_commands_audit.md` | 6.1 KB |
