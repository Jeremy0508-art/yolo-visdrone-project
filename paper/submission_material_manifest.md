...
| --- | --- | --- | --- | --- |
| Core Documents | LaTeX source | READY | `paper/manuscript_submission_candidate.tex` | 43.4 KB |
...
| Core Documents | Advisor progress brief | READY | `paper/advisor_progress_brief.md` | 4.8 KB |
| Core Documents | Execution log | READY | `paper/CEA_EXECUTION_LOG.md` | 47.2 KB |
...
| Tables | Main comparison table | READY | `paper/tables/main_comparison_for_paper.csv` | 8 data rows |
| Tables | Ablation table | READY | `paper/tables/ablation_results.csv` | 6 data rows |
| Tables | Speed table | READY | `paper/tables/speed_results.csv` | 8 data rows |
...
| Tables | Accuracy-speed trade-off table | READY | `paper/tables/accuracy_speed_tradeoff.csv` | 8 data rows |
| Tables | Fair experiment status table | READY | `paper/tables/cea_experiment_status.csv` | 5 data rows |
| Tables | Server status history table | READY | `paper/tables/cea_server_status_history.csv` | 165 data rows |
...
| Figures | Accuracy-speed trade-off figure | READY | `paper/figures/tradeoff/accuracy_speed_tradeoff.png` | 110.2 KB |
...
| Audits | Evidence audit | READY | `paper/evidence_audit.md` | 11.3 KB |
| Audits | Manuscript number trace audit | READY | `paper/manuscript_number_trace_audit.md` | 46.7 KB |
...
| Audits | Synced fair-experiment artifacts audit | READY | `paper/synced_fair_experiment_artifacts_audit.md` | 2.7 KB |
