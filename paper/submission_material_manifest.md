...
| Core Documents | Execution log | READY | `paper/CEA_EXECUTION_LOG.md` | 26.8 KB |
...
| Tables | Server status history table | READY | `paper/tables/cea_server_status_history.csv` | 50 data rows |
