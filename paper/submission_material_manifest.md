...
| Core Documents | Paper workspace README | READY | `paper/README.md` | 7.8 KB |
...
| Core Documents | Reproducibility commands | READY | `paper/commands.md` | 13.5 KB |
...
| Core Documents | Execution log | READY | `paper/CEA_EXECUTION_LOG.md` | 30.1 KB |
...
| Tables | Server status history table | READY | `paper/tables/cea_server_status_history.csv` | 75 data rows |
...
| Audits | Submission audit dashboard | READY | `paper/submission_audit_dashboard.md` | 2.5 KB |
| Audits | Submission readiness audit | READY | `paper/submission_readiness_audit.md` | 9.4 KB |
...
| Audits | Reproducibility command audit | READY | `paper/repro_commands_audit.md` | 4.0 KB |
