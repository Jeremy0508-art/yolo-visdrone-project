...
| --- | --- | --- | --- |
| Chinese character volume | PARTIAL | `6727 Chinese characters; target >= 7500` | Expand introduction, related work, method rationale, fair-comparison analysis, discussion, and limitations after server results are complete. |
