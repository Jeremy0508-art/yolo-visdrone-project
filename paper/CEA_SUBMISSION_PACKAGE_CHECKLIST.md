...
| Tables | Main result table | READY | `paper/tables/main_comparison_for_paper.csv; 8 data rows` |  |
...
| Experiment Gate | Fair-comparison server experiments | PENDING | `1/5 completed experiments` | Wait for complete 100-epoch runs, then sync with tools/sync_cea_server_results.ps1 -MinEpochs 100. |
