...
1. 先用表 1 说明 960 输入分辨率是当前主要增益来源，并突出 YOLO11n-P2-960 相对 YOLO11n-960 的额外收益。
2. 再用表 2 说明各改进项的贡献，强调 P2 在高分辨率下仍有效，CoordAttention 当前不能夸大为决定性贡献。
3. 最后用表 3 分析速度和复杂度，说明高分辨率和结构增强带来额外耗时，但仍保持较高 FPS。
