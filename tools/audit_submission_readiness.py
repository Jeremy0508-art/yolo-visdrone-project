...
def audit() -> list[Check]:
    ...
    required_docs = [
        ...
        ("CEA reviewer response prep audit", "paper/cea_reviewer_response_prep_audit.md"),
        ("CEA post-result rewrite playbook audit", "paper/cea_post_result_rewrite_playbook_audit.md"),
        ("CEA official requirements tracker audit", "paper/cea_official_requirements_tracker_audit.md"),
    ...
    tool_files = [
        ...
        ("PDF review contact-sheet renderer", "tools/render_pdf_review_contact_sheet.py"),
        ("GitHub public view audit script", "tools/check_github_public_view.py"),
        ("Advisor progress brief builder", "tools/build_advisor_progress_brief.py"),
        ("Advisor review package builder", "tools/build_advisor_review_package.py"),
        ...
        ("CEA reviewer response prep builder", "tools/build_cea_reviewer_response_prep.py"),
        ("CEA reviewer response prep audit script", "tools/check_cea_reviewer_response_prep.py"),
        ("CEA post-result rewrite playbook builder", "tools/build_cea_post_result_rewrite_playbook.py"),
        ("CEA post-result rewrite playbook audit script", "tools/check_cea_post_result_rewrite_playbook.py"),
        ("CEA official requirements tracker builder", "tools/build_cea_official_requirements_tracker.py"),
        ("CEA official requirements tracker audit script", "tools/check_cea_official_requirements_tracker.py"),
