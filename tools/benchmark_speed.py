...
TARGETS = [
    ...
    BenchmarkTarget(
        ...
        weights="runs/detect/baseline_yolo11s_960_visdrone/weights/best.pt",
        imgsz=960,
    ),
    BenchmarkTarget(
        model="YOLOv5n baseline",
        weights="runs/detect/baseline_yolov5n_visdrone/weights/best.pt",
        imgsz=640,
    ),
    BenchmarkTarget(
    ...
    BenchmarkTarget(
        ...
        weights="runs/detect/baseline_yolo11n_960_visdrone/weights/best.pt",
        imgsz=960,
    ),
    BenchmarkTarget(
        model="YOLO11n-P2",
