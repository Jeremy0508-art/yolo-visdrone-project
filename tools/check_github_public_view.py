...
def audit() -> list[Check]:
    ...
    public_artifacts = [
        ...
        (
            "IEEE front matter audit raw",
            "https://raw.githubusercontent.com/Jeremy0508-art/yolo-visdrone-project/main/paper/ieee_front_matter_audit.md",
        ),
        (
            "IEEE submission metadata workbench raw",
        ...
        (
            "IEEE result interpretation matrix raw",
            "https://raw.githubusercontent.com/Jeremy0508-art/yolo-visdrone-project/main/paper/ieee_result_interpretation_matrix.md",
        ),
        (
            "IEEE result interpretation audit raw",
        ...
        (
            "IEEE manuscript assembly audit raw",
            "https://raw.githubusercontent.com/Jeremy0508-art/yolo-visdrone-project/main/paper/ieee_manuscript_assembly_audit.md",
        ),
        (
        ...
        (
            "IEEE dataset compliance audit raw",
