...
DIRECT_CLAIMS: list[DirectClaim] = [
    ...
    DirectClaim("Speed", "YOLO11n-960 latency", "16.37", "paper/tables/speed_results.csv", ("YOLO11n baseline 960", ""), "mean_latency_ms_wall", 2),
    DirectClaim("Speed", "YOLO11n-P2-960 weight size", "6.06", "paper/tables/model_complexity.csv", ("YOLO11n-P2-960", ""), "weight_size_mb", 2),
    DirectClaim("Speed", "YOLO11n-P2-960 latency", "17.96", "paper/tables/speed_results.csv", ("YOLO11n-P2-960", ""), "mean_latency_ms_wall", 2),
    ...
    DirectClaim("Speed", "YOLO11n-P2-CA-960 latency", "19.00", "paper/tables/speed_results.csv", ("YOLO11n-P2-CoordAttention-960", ""), "mean_latency_ms_wall", 2),
    ...
    DirectClaim("Speed", "YOLO11s-960 latency", "16.10", "paper/tables/speed_results.csv", ("YOLO11s baseline 960", ""), "mean_latency_ms_wall", 2),
