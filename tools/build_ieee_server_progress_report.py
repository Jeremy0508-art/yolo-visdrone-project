...
HISTORY_PATH = ROOT / "paper/tables/ieee_server_status_history.csv"
REPORT_PATH = ROOT / "paper/ieee_server_progress_report.md"
    ...
    for run, items in grouped.items():
        ...
        progress.append(
            RunProgress(
                ...
                recent_epoch_gain=to_int(latest.get("epochs", ""))
                - to_int(previous.get("epochs", "")),
...
def write_report(progress: list[RunProgress]) -> None:
    ...
    if latest_item and latest_item.processes:
        lines.append(f"| `{latest_item.processes}` |")
    else:
        lines.append("| `n/a` |")
