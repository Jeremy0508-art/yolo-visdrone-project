...
DISPLAY_NAMES = {
    ...
    "YOLO11n-P2-ScaleGate-960": "YOLO11n-P2-ScaleGate-960",
    "YOLO11n-P2-CSGate-960": "YOLO11n-P2-CSGate-960",
}
...
def table_env(
    ...
    tabular_begin = (
        f"\\begin{{tabular*}}{{\\textwidth}}{{@{{\\extracolsep{{\\fill}}}}{columns}@{{}}}}"
        if wide
        else f"\\begin{{tabular}}{{{columns}}}"
    )
    tabular_end = "\\end{tabular*}" if wide else "\\end{tabular}"
    lines = [
