...
PACKAGE_ITEMS = [
    ...
    PackageItem("paper/cea_template_migration/cea_word_draft_quality_audit.md", "Mechanical quality audit for the CEA Word draft."),
    ...
    PackageItem("paper/CEA_WORD_VISUAL_REVIEW_FORM.md", "Manual Word/WPS review form for the CEA Word draft."),
