...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Run YOLO inference on an image or image directory.")
    ...
    parser.add_argument("--project", default="runs/detect_image", help="Output project directory.")
